...
window.onload = function () {
  ...
  const calendarMonths = document.getElementsByClassName("ct_current_calendar-months")[0];
  const calendarYears = document.getElementsByClassName("ct_current_calendar-years")[0];
